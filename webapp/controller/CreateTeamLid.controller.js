sap.ui.define([
	...
	return BaseController.extend("ehb.Project.controller.CreateTeamLid", {
		
	
		
		createLid: function(){
			
			var Naam = this.byId("naam").valueOf().mProperties.value;
			
			var Voornaam = this.byId("vn").valueOf().mProperties.value;
			...
			this.getView().getModel().create("/teamlidSet",properties,
			{
			...
			onInit: function () {
			var that = this;
			this.getRouter().getTargets().getTarget("create");
